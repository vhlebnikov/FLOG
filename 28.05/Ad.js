        ...
        <Container>
                ...
                {categoryRoute ? (
                    <Form >
                        <div style={{ marginTop: '10px', marginBottom: '-20px'}}>
                            <Breadcrumb >
                                {categoryRoute.map(i => (
                                    <BreadcrumbItem key={i.id} onClick={() => setCategoryAndSearch(i.id)} style={{fontFamily: 'Century Gothic', fontWeight: 500, fontSize: 15}}>
                                        {i.name}
                                    </BreadcrumbItem>
                                ))}
                            </Breadcrumb>
            ...
            <Row style={{
                ...
                <Col md={3}>
                    {/*Профиль*/}
                    {userLoc ?
                        <Card style={{ backgroundColor: '#D3D3D3'}} className="shadow-box" >
                            <div>
                                {userLoc.image ?
                                    <div style={{
                                        width: "60px",
