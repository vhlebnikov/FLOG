        ...
        <div>
            <Row>
                <div style={{ textAlign: 'center', marginTop: '50px'  }}>
                    ...
                    <img className="gradientMain" src={FrogSmileGreen} style={{ width: '200px', height: '200px', marginTop: '10px', marginBottom: '40px'    }} />
                </div>
            </Row>
            <Row>
                    ...
                    return (
                        <div key={category.value} className="col-md-4">
                            <Panel shaded style={{marginTop: 10, marginLeft: 20, marginRight: 20}} onClick={() => handleClick(1)}>
                                ...
                                <img src={image} width={100} height={100} style={{ float: "right"}}/>
                                <p>{description}</p>
                            </Panel>
                        </div>
                    );
